...
# Draw plot 2 (rigth-up)
plot(as.numeric(my_data_on_date$Voltage),type="l",ylab="Voltage",xlab="datetime",axes=FALSE)
axis(side=1, at=c(1,1400,2800), labels=c("Thu", "Fri", "Sat"))
axis(side=2, at=c(234,236,238,240,242,244,246), labels=c("234","","238","","242","","246"))
box()

#Draw plot 3 (left-down)
plot(as.numeric(my_data_on_date$Sub_metering_1),type="l",ylab="Energy sub metering",xlab="",axes=FALSE)
...
#Draw plot 4 (rigth-down)
plot(as.numeric(my_data_on_date$Global_reactive_power),type="l",ylab="Global_reactive_power",xlab="datetime",axes=FALSE)
axis(side=1, at=c(1,1400,2800), labels=c("Thu", "Fri", "Sat"))
